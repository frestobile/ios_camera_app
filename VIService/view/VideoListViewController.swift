...
class VideoListViewController: UIViewController {
    ...
    @objc func updateUI() {
        cancelBtn.setTitle(LanguageManager.shared.localizedString(for: "cancel"), for: .normal)
        noVideoLabel.text = LanguageManager.shared.localizedString(for: "no_video")
    }
...
//            emptyView.isHidden = true
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            self.showAlert(title: "VIServ", message: LanguageManager.shared.localizedString(for: "is_sure")) { alertAction in
                if alertAction {
